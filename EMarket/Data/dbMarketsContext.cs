...
namespace EMarket.Data
{
    public partial class dbMarketsContext : DbContext
    {
        ...
        public virtual DbSet<EMarket.Models.Attribute> Attributes { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Server=LAPTOP-FQHMPOFH\\MSSQLSERVER01;Database=dbMarkets;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EMarket.Models.Attribute>(entity =>
            {
